...
int main(int argc, char **argv) {
  ...
  // 输出重采样结果
  pcl::io::savePCDFile("./KdTreePC.pcd", *cloud_smoothed);
  // 法线估计
  ...
  viewer->setPointCloudRenderingProperties(
      pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "smooth cloud");
  viewer->addPointCloudNormals<PointT, pcl::Normal>(cloud_smoothed, normals, 20,
                                                    0.05, "normals");
